...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-content">
        <div class="panel">
            <div class="panel-body container-fluid">
                <form  name="userForm" action="<?php echo e(URL::to('addStudentData')); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row row-lg">
                        <div class="col-sm-12" >
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <p class="font-size-20 blue-grey-700" style="color: #4F0800;">Add Student</p>
                                ...
                                <div class="form-group col-sm-6">
                                    <input type="file" class = "form-control <?php echo e(($errors->has('uploadFile'))?'errorBox':''); ?>" name="uploadFile" id="exampleInputFile"  value="<?php echo e(old('uploadFile')); ?>" required>
                                ...
                                <div class="form-group">
                                    <a href = "#" id = "download1"><b>Download Sample Student Excel Format</b></a>
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-sm-6">
    ...
    <script>
        $('#download1').click(function(e) {
            ...
            var url = base_url+"public/assets/format_excelsheet/Student_Data_Fromat.xlsx";
            e.preventDefault();
