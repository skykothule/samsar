...
<?php $__env->startSection('content'); ?>
    <div class="page-header">
        <h1 class="page-title font_lato">Tracking Import</h1>
    ...
    <div class="page-content" ng-app="">
        <div class="panel">
            <div class="panel-body container-fluid">
                ...
                <form name="userForm" action="<?php echo e(URL::to('trackingimportcsv')); ?>" ng-submit="submitForm(userForm.$valid)"  method="post" accept-charset="utf-8" enctype="multipart/form-data" class="ng-pristine ng-valid">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="bs-example" data-example-id="single-button-dropdown">
                            ...
                            <div class="btn-group">
                                <a class="btn btn-default" href="<?php echo e(URL::to('public/images/trackings.csv')); ?>"><span class="glyphicon glyphicon-download-alt"></span>  Dowload Sample</a>
                            </div>
                            <div class="btn-group">
