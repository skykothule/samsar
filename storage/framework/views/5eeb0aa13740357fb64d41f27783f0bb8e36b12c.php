...
<div class="page animsition vertical-align text-center" data-animsition-in="fade-in"
  data-animsition-out="fade-out">
	...
	<div class="page-content vertical-align-middle" style="background: rgba(129, 136, 136, 0.17);border: 1px solid;border-radius: 10px;box-shadow: 5px 5px 5px 5px #b5adad;">
      <div class="brand">
