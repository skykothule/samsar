...
<div style="clear:both;"></div><br/>	 
	...
	<table class="tablesaw table-striped table-bordered tablesaw-columntoggle" data-tablesaw-mode="columntoggle" data-tablesaw-minimap="" id="table-3973">
		<thead>
		  <tr>
			  <th data-tablesaw-priority="6" class="tablesaw-priority-5 tablesaw-cell-visible"><?php echo e(trans('app.name')); ?></th>
			  <th data-tablesaw-priority="5"><?php echo e(trans('app.username')); ?></th>
			  <th data-tablesaw-priority="4"><?php echo e(trans('app.email_address')); ?></th>
			  <th data-tablesaw-priority="3">Organization</th>
		...
		<?php $__currentLoopData = $userdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $view): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<tr>
			  <td class="tablesaw-priority-6 tablesaw-cell-visible"><?php echo e($view->first_name); ?> <?php echo e($view->last_name); ?></td>
			  <td class="tablesaw-priority-5"><?php echo e($view->username); ?></td>
			  <td class="tablesaw-priority-4"><?php echo e($view->email); ?></td>
