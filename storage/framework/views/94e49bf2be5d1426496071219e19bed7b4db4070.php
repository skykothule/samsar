...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-content">
        <div class="panel">
            <div class="panel-body container-fluid">
                <form  name="userForm" action="<?php echo e(URL::to('uploadActivitySheet')); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row row-lg">
                        <div class="col-sm-12" >
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <p class="font-size-20 blue-grey-700" style="color: #4F0800;">New Non Scholastic activity</p>
                                ...
                                <div class="form-group col-sm-6">
                                    <div class="input-group">
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="exampleInputFile">Upload Time Table File</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-sm-6"><br><br></div>
                                <div class="form-group">
                                    <a href = "#" id = "download1"><b>Download Sample Non Scholastic Activity Excel Format</b></a>
                                </div>
    ...
    <script>
        $('#download1').click(function(e) {
            ...
            var url = base_url+"public/assets/format_excelsheet/post_school_activity_sheet.xlsx";
            e.preventDefault();
