...
<body class="dashboard app-mailbox">
 ...
 <?php if (\Entrust::can(['users.manage', 'users.activity'])) : ?>	
      ...
      <!-------------- Customers  menu --------------->
		<?php if (\Entrust::can('customer.customers')) : ?>
			 <li class="site-menu-item has-sub <?php echo e(Request::is('customers') ? 'active open' : ''); ?>">
              <a href="javascript:void(0)">
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item <?php echo e(Request::is('customers') ? 'active' : ''); ?>">
                  <a class="animsition-link" href="<?php echo e(URL::to('/customers')); ?>">
                    <span class="site-menu-title">Customers</span>
                  </a>
                </li>
              </ul>
