...
<head>
 ...
 <!-- Stylesheets -->
    ...
    <link rel="stylesheet" href="<?php echo e(URL::to('public/global/vendor/filament-tablesaw/tablesaw.css')); ?>">
...
<body class="dashboard app-mailbox">
  ...
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
		...
		<img class="navbar-brand-logo" src="<?php echo e(URL::to('public')); ?>/uploads/<?php echo e($view->logo); ?>" title="<?php echo e($view->app_name); ?>">
    ...
    <div class="navbar-container container-fluid">
      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
          ...
          <li class="dropdown">
            ...
            data-animation="scale-up" role="button">
			  ...
			  <?php if(!empty(Auth::user()->image)): ?>				
                <img src="<?php echo e(URL::to('public')); ?>/uploads/<?php echo e(Auth::user()->image); ?>" alt="...">
			  <?php else: ?>
				   <img src="<?php echo e(URL::to('public')); ?>/images/default.png" alt="...">
				 <?php endif; ?>
                <i></i>
              </span>
            </a>
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right navbar-brand navbar-brand-center" style="font-size: 14px !important;">
          ...
          <li class="">
            <span class="brand-text hidden-xs">Hello, <?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?> </span>
          </li>
        </ul>
 ...
 <!-------------- Dashboard menu --------------->
	...
	<!-------------- Users menu --------------->	
      ...
      <!-------------- Customers  menu --------------->
            <?php if (\Entrust::can(['OrderBasic','OrderPlus','Booking','OrderAdvance'])) : ?>
			 <li class="site-menu-item has-sub <?php echo e(Request::is('orderlist','createorder') ? 'active open' : ''); ?>">
              <a href="javascript:void(0)">
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item <?php echo e(Request::is('orderlist') ? 'active' : ''); ?>">
                  <a class="animsition-link" href="<?php echo e(URL::to('/orderlist')); ?>">
                    <span class="site-menu-title">Order List</span>
                  </a>
                </li>
                <?php if (\Entrust::can('OrderBasic')) : ?>
                <li class="site-menu-item <?php echo e(Request::is('createorder') ? 'active' : ''); ?>">
                  <a class="animsition-link " href="<?php echo e(URL::to('createorder')); ?>">
                    <span class="site-menu-title"><?php echo e('New Order Item'); ?></span>
                  </a>
                </li>
                <?php endif; // Entrust::can ?>
              </ul>
            ...
            <?php if (\Entrust::can(['company.manage'])) : ?>
            <li class="site-menu-item has-sub <?php echo e(Request::is('company','hrquestions') ? 'active open' : ''); ?>">
              <a href="javascript:void(0)">
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item <?php echo e(Request::is('company') ? 'active' : ''); ?>">
                  <a class="animsition-link" href="<?php echo e(URL::to('/company')); ?>">
                    <span class="site-menu-title">Company List</span>
                  </a>
                </li>
                <li class="site-menu-item <?php echo e(Request::is('companyregistration') ? 'active' : ''); ?>">
                  <a class="animsition-link " href="<?php echo e(URL::to('/companyregistration')); ?>">
