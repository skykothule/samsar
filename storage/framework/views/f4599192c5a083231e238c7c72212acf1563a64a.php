...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-header">
        <h1 class="page-title font_lato"><?php echo e('Register New Company'); ?></h1>
    ...
    <div class="page-content" ng-app="app">
        <div class="panel">
            <div class="panel-body container-fluid">
                ...
                <form  name="userForm" action="<?php echo e(URL::to('companystore')); ?>" ng-submit="submitForm(userForm.$valid)" novalidate enctype="multipart/form-data"  id="demo-form2" data-parsley-validate="" method="post" novalidate="">
                        ...
                        <div class="col-sm-12" >
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="comapny_name" ng-model="comapny_name" name="comapny_name" ng-init="comapny_name='<?php echo e(old('comapny_name')); ?>'" placeholder="<?php echo e('Enter Company Name'); ?>" required>
                                </div>
                                <div class="form-group col-sm-6">
                            ...
                            <div class="form-group col-sm-6">
                                <button type="submit" ng-disabled="userForm.$invalid" class="btn btn-primary ladda-button" data-plugin="ladda" data-style="expand-left">
                                    <i class="fa fa-save"></i>  <?php echo e('Register'); ?>
