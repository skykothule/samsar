...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-content">
        <div class="panel">
            ...
            <div class="panel-body container-fluid">
                ...
                <form  name="userForm" action="<?php echo e(URL::to('listYearlyEvent')); ?>" method="post">
                    ...
                    <div class="row row-lg">
                        <div class="col-sm-12" >
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <p class="font-size-20 blue-grey-700" style="color: #4F0800;">Yearly Event</p>
                                    ...
                                    <div class="form-group col-sm-6">
                                        <select class = "form-control" name="year" id="year" required>
                                            ...
                                            <?php endfor; ?>
                                            <?php $j = $i+1; ?>
                                            <option value="<?php echo e($i."-".$j); ?>" selected><?php echo e($i."-".$j); ?></option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <table class="table" id="example">
                                            ...
                                            <?php $__currentLoopData = $event_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($event->sub_event_name); ?></td>
                                                    <td><?php echo e($event->day); ?></td>
                                                    <td><?php echo e($event->grade); ?></td>
                                                    <td><?php echo e(date("d-m-Y",strtotime($event->date))); ?></td>
                                                    <td><?php echo e($event->timing); ?></td>
                                                    <td><?php echo e($event->session); ?></td>
                                                    <td><?php echo e($event->venue); ?></td>
                                                    <td>
                                                        <div class="btn-group">
                                                            <button type="button" class="btn btn-sm btn-success mr-1" onclick="viewEventDetails(<?php echo e($event->sub_event_id); ?>)" data-toggle="modal" data-target="#myModal" >View</button>
                                                            <button type="button" class="btn btn-sm btn-default mr-1" onclick="editEventDetails(<?php echo e($event->sub_event_id); ?>)" data-toggle="modal" data-target="#myEditModal" >Edit</button>
    ...
    <script>
        ...
        function viewEventDetails(student_id){
...
//                    alert(obj.name);
        ...
        function editEventDetails(student_id){
            var base_url= basePath();
            $.ajax({
                url: base_url+'getStudentDetails/{id}',
                type: 'GET',
