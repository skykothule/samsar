...
class UserController extends Controller
{
    ...
    public function index(Request $request){
	   ...
	   $userdata = User::select('users.*','tbl_company.company_name')
	...
	public function xlsexport(){	
		$users = User::select('first_name','last_name','email', 'username','phone','gender','role','status')->orderBy('id', 'DESC')->get();
    ...
    public function registration(Request $request){
		...
		if(Auth::user()->hasRole('Webmaster')){
            $roles = DB::table('roles')->whereIn('id',array(3,4))->get();
        }else{
            $roles = DB::table('roles')->get();
        }

       return view('users.registration',compact('country','roles','company'));
    }
    ...
    public function edit($id){
	  ...
	  $roles = DB::table('roles')->get();
	  $country = DB::table('country')->get();
      return view('users.edit_user',compact('userdata','country','roles','company'));
    }
