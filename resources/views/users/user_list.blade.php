...
<div style="clear:both;"></div><br/>	 
	...
	<table class="tablesaw table-striped table-bordered tablesaw-columntoggle" data-tablesaw-mode="columntoggle" data-tablesaw-minimap="" id="table-3973">
		<thead>
		  <tr>
			  <th data-tablesaw-priority="6" class="tablesaw-priority-5 tablesaw-cell-visible">{{ trans('app.name')}}</th>
			  <th data-tablesaw-priority="5">{{ trans('app.username')}}</th>
			  <th data-tablesaw-priority="4">{{ trans('app.email_address')}}</th>
		...
		@foreach($userdata as $view)
			<tr>
			  <td class="tablesaw-priority-6 tablesaw-cell-visible">{{$view->first_name}} {{$view->last_name}}</td>
			  <td class="tablesaw-priority-5">{{$view->username}}</td>
			  <td class="tablesaw-priority-4">{{$view->email}}</td>
